                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInRight" data-delay=".4s">Gratis Ongkir</span>
                                    <h1 data-animation="fadeInRight" data-delay=".6s">Barang <br> Electronic</h1>
                                    <p data-animation="fadeInRight" data-delay=".8s">Sampai 10 Desember 2020!</p>
                                    <!-- Hero-btn -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="assets/img/categori/cat1.png" alt="">
                     ...
                     <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img text-center">
                                <img src="assets/img/categori/cat2.png" alt="">
                                <div class="category-caption">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="assets/img/categori/cat3.png" alt="">
                                <div class="category-caption">
                                    <h2>Masker</h2>
                                    <span class="best"><a href="#">Masker kain 3 PLY</a></span>
                                    <span class="collection">New Collection</span>
                                </div>
                            </div>
                        </div>
